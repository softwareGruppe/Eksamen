...
public class BookingTest {
    ...
    public void Booking_End_Time_Is_Empty() {
        assertEquals(Functions.BookListingFieldCheck("B", "B", "B", "B", "B", "B", "B", "B", "B", ""), "Booking EndTime cannot be empty");
    }

    @Test
    public void Booking_End_Date_Is_Empty() {
        assertEquals(Functions.BookListingFieldCheck("Dn123434", "BMW", "BMW 550D", "2015", "50000", "3000", "25-11-2022", "14:00", "", "14:00"), "Booking EndDate cannot be empty");
    }

    @Test
    public void Booking_Start_Time_is_Empty() {
        assertEquals(Functions.BookListingFieldCheck("Dn123434", "BMW", "BMW 550D", "2015", "50000", "3000", "25-11-2022", "", "26-11-2022", "14:00"), "Booking StartTime cannot be empty");

    }

    @Test
    public void Booking_Start_Date_isEmpty() {
        assertEquals(Functions.BookListingFieldCheck("Dn123434", "BMW", "BMW 550D", "2015", "50000", "3000", "", "14:00", "26-11-2022", "14:00"), "Booking StartDate cannot be empty");
    }
